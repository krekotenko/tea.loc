...
class ControllerExtensionShippingFlat extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['shipping_flat_sum_free_shipping'])) {
            $data['shipping_flat_sum_free_shipping'] = $this->request->post['shipping_flat_sum_free_shipping'];
        } else {
            $data['shipping_flat_sum_free_shipping'] = $this->config->get('shipping_flat_sum_free_shipping');
        }
